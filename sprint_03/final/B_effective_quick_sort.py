...
"""
Успешное решение: https://contest.yandex.ru/contest/23815/run-report/158133021/
(обновлено)
Принцип работы
...
Выбор пивота - случайное значение из диапазона left - right (randint)
...
Лучший случай: O(n logn) - когда pivot выбран оптимально (близко к середине) - изменено на выбор случайного.
